...
(function() {
  var RedisInst, RedisSMQ, _, async, redis, should, testNamespace;
  ...
  describe('Redis-Simple-Message-Queue Test', function() {
    var q1m1, q1m2, q1m3, q2m2, q2msgs, queue1, queue2, queue3, rsmq, rsmq2;
    rsmq = null;
    rsmq2 = null;
    queue1 = "test1";
    queue2 = "test2";
    ...
    describe('SUBSCRIBE', function() {
      it('Create a new queue: queue3', function(done) {
        rsmq.createQueue({
          qname: queue3
        }, function(err, resp) {
          should.not.exist(err);
        ...
        rsmq.on("message", function() {
          console.log(arguments);
        });
      });
      return it('Subscribe to the queue and wait for a message', function(done) {
        var _fnSubscription, _msg_id;
        _msg_id = null;
        _fnSubscription = function(msg_id) {
          should.exist(msg_id);
    ...
    describe('CLEANUP', function() {
      ...
      it('Remove queue3', function(done) {
        rsmq.deleteQueue({
          qname: queue3
        }, function(err, resp) {
          should.not.exist(err);
